...
public class TestDeltaLakeFileStatistics
{
    ...
    private static void testStatisticsValues(DeltaLakeFileStatistics fileStatistics)
    {
        ...
        assertThat(fileStatistics.getMinColumnValue(new DeltaLakeColumnHandle("ts", TIMESTAMP_TZ_MICROS, OptionalInt.empty(), "ts", TIMESTAMP_TZ_MICROS, REGULAR, Optional.empty()))).isEqualTo(Optional.of(packDateTimeWithZone(LocalDateTime.parse("2960-10-31T01:00:00.000").toInstant(UTC).toEpochMilli(), UTC_KEY)));
